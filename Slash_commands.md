...
/compact [instructions] compacts the session context. See /concepts/compaction.
...
/btw <question> asks a side question without changing future session context. See /tools/btw.
...
/tts on|off|status|provider|limit|summary|audio|help controls TTS. See /tools/tts.
